      ...
      <div className="container mx-auto flex flex-wrap justify-between items-center">
        ...
        <div className="flex flex-wrap items-center space-x-4">
          ...
          <div className="flex items-center space-x-1">
            {/* Schedule Icon */}
            <Image src="/icons/schedule.svg" width={16} height={16} alt={t('topHeader.scheduleAlt', { defaultValue: 'Schedule'})} className="w-4 h-4" />
            <span>{t('topHeader.scheduleText', { defaultValue: '周一至周五 08:00 - 18:00 / 周日 08:00 - 14:00'})}</span>
          </div>
          {/* Phone */}
          <div className="flex items-center space-x-1">
            {/* Phone Icon */}
            <Image src="/icons/call.svg" width={16} height={16} alt={t('topHeader.phoneAlt', { defaultValue: 'Call'})} className="w-4 h-4" />
            <span>{t('topHeader.phoneNumber', { defaultValue: '+86 138 1234 5678'})}</span>
          </div>
          {/* Location */}
          <div className="flex items-center space-x-1">
            {/* Location Icon */}
             <Image src="/icons/location_on.svg" width={16} height={16} alt={t('topHeader.locationAlt', { defaultValue: 'Location'})} className="w-4 h-4" />
